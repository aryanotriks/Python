...
\033[1;97m                /(                                 
\033[1;94m               (__)                                 
     \x1b[1;97m Author   \033[31;1m:  \033[32mSayyed Zakarya
     \x1b[1;97m Type     \033[31;1m:  \033[32mBruteForce
     \x1b[1;97m Version  \033[31;1m:  \033[32m0.1
     \x1b[1;97m Whatsapp  \033[31;1m:  \033[32m03472860857
     \x1b[1;97m
"""
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : Aryanotricks.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : Sayyed Zakarya Bacha.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/aryanotriks'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/sayyed.302'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : Aryano Tricks'%(N,H,N);time.sleep(0.07)
